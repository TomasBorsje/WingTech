...
public class WorldGen {
    ...
    public static void generateChunk(final BiomeLoadingEvent event)
    {
        ...
        ConfiguredFeature<?, ?> FLOWER_GEN = Feature.FLOWER.configured(FLOWER_CONFIG).decorated(Features.Placements.ADD_32).decorated(Features.Placements.HEIGHTMAP_SQUARE).count(1);
